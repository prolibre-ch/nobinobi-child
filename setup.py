...
setup(
    ...
    install_requires=[
        "djangorestframework==3.11.1", "django>=3.0", "django-model-utils==4.0.0", "django-phonenumber-field==5.0.0",
        ...
        "django-bootstrap-datepicker-plus==3.0.5", "django-simple-menu==1.2.1", "django-extensions==3.0.6",
