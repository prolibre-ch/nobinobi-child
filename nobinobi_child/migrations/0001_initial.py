# Generated by Django 2.2 on 2019-04-18 05:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('status', model_utils.fields.StatusField(choices=[('archived', 'Archived'), ('in_progress', 'In progress'), ('future', 'future')], default='archived', max_length=100, no_check_for_status=True, verbose_name='status')),
                ...
                ('usual_name', models.CharField(max_length=100, verbose_name='Nom de famille')),
                ...
                ('red_list', models.CharField(max_length=255, verbose_name='Red list')),
                ...
                ('allergies', models.ManyToManyField(related_name='allergies', to='nobinobi_child.Allergy', verbose_name='Allergies')),
            ],
            options={
                'verbose_name': 'Child',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('name', models.CharField(max_length=50, verbose_name='Nom')),
                ('weekday', model_utils.fields.StatusField(choices=[(1, 'lundi'), (2, 'mardi'), (3, 'mercredi'), (4, 'jeudi'), (5, 'vendredi'), (6, 'samedi'), (7, 'dimanche')], default=1, max_length=100, no_check_for_status=True, verbose_name='Weekday')),
                ('order', models.PositiveIntegerField(verbose_name='Ordre')),
            ],
            options={
                'verbose_name': 'Period',
        ...
        migrations.AddField(
            model_name='child',
            name='contacts',
            field=models.ManyToManyField(related_name='contacts', through='nobinobi_child.ChildToContact', to='nobinobi_child.Contact', verbose_name='Contacts'),
        ),
        migrations.AddField(
            model_name='child',
            name='food_restrictions',
            field=models.ManyToManyField(related_name='food_restrictions', to='nobinobi_child.FoodRestriction', verbose_name='Food restrictions'),
        ),
        migrations.AddField(
            model_name='child',
            name='languages',
        ...
        migrations.AddField(
            model_name='child',
            name='periods',
            field=models.ManyToManyField(related_name='periods', through='nobinobi_child.ChildToPeriod', to='nobinobi_child.Period', verbose_name='Periods'),
        ),
        migrations.AddField(
            model_name='child',
            name='staff',
